    ...
    <div className="min-h-screen bg-[#070b14] text-slate-200 font-sans selection:bg-purple-500 selection:text-white relative overflow-hidden scroll-smooth">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-[#070b14]/90 border-b border-white/5 flex justify-between items-center p-5 lg:px-24 transition-all">
        ...
        <div className="space-x-8 hidden md:flex items-center text-sm font-medium text-gray-300">
          ...
          <a href="#contact" className="relative inline-flex h-10 items-center justify-center rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 px-6 font-medium text-white hover:scale-105 transition-all shadow-[0_0_15px_rgba(147,51,234,0.4)]">
            Let's Talk
          </a>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed top-[88px] left-0 w-full bg-[#070b14]/95 backdrop-blur-xl border-b border-white/10 z-40 flex flex-col p-6 gap-6 text-center shadow-2xl">
          <a href="#about" onClick={closeMenu} className="text-lg font-medium text-gray-300 hover:text-purple-400">About</a>
          <a href="#services" onClick={closeMenu} className="text-lg font-medium text-gray-300 hover:text-teal-400">Services</a>
          <a href="#projects" onClick={closeMenu} className="text-lg font-medium text-gray-300 hover:text-purple-400">Work</a>
      ...
      <main className="relative flex flex-col items-center justify-center text-center px-6 pt-24 pb-24 z-10">
        ...
        <p className="text-gray-300 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
          Whether you run a local shop, a wellness studio, or a growing startup, I create beautiful, fast websites that turn your visitors into paying clients.
        </p>
        <a href="#services" className="bg-white text-[#070b14] px-8 py-4 rounded-full text-lg font-bold hover:scale-105 transition-all">
          See How I Can Help
        </a>
      </main>
      ...
      <section id="about" className="relative px-6 lg:px-24 pb-24 z-10">
        <div className="bg-slate-800/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-10 md:p-16 max-w-5xl mx-auto shadow-2xl">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 text-left">More Than Just A Web Developer</h2>
          <p className="text-gray-300 text-lg leading-relaxed mb-6 text-left">
            I don't just design pretty interfaces; I build robust full-stack solutions. With a strong foundation in frontend technologies and backend Database Management, I ensure your business data is secure.
          </p>
          <p className="text-gray-300 text-lg leading-relaxed mb-8 text-left">
            Beyond coding, I understand e-commerce logistics, product packing workflows, and retail sales. I build tools that solve your daily operational challenges. We prioritize clear English communication without confusing technical jargon.
          </p>
          <div className="flex flex-wrap gap-3">
            <span className="bg-purple-500/20 text-purple-300 px-4 py-2 rounded-full text-sm font-semibold border border-purple-500/30">Business Logic</span>
            <span className="bg-teal-500/20 text-teal-300 px-4 py-2 rounded-full text-sm font-semibold border border-teal-500/30">Full-Stack Architecture</span>
            <span className="bg-blue-500/20 text-blue-300 px-4 py-2 rounded-full text-sm font-semibold border border-blue-500/30">Secure Databases</span>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="relative px-6 lg:px-24 pb-32 z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Everything you need to establish a strong digital presence.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-slate-800/60 p-8 rounded-3xl border border-white/10 hover:border-teal-500/50 transition-colors">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Attract More Clients</h3>
            <p className="text-gray-400 text-sm">I design attractive Landing Pages that highlight your services and encourage people to contact you.</p>
          </div>
          <div className="bg-slate-800/60 p-8 rounded-3xl border border-white/10 hover:border-purple-500/50 transition-colors">
            <div className="text-4xl mb-4">🛒</div>
            <h3 className="text-xl font-bold text-white mb-3">Sell Products Online</h3>
            <p className="text-gray-400 text-sm">I build secure and easy-to-use digital storefronts for your retail business or clothing brand.</p>
          </div>
          <div className="bg-slate-800/60 p-8 rounded-3xl border border-white/10 hover:border-pink-500/50 transition-colors">
            <div className="text-4xl mb-4">⏱️</div>
            <h3 className="text-xl font-bold text-white mb-3">Save Your Time</h3>
            <p className="text-gray-400 text-sm">Custom management systems (Hotel/Booking) to automate your daily business tasks.</p>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="relative px-6 lg:px-24 pb-32 z-10">
        <h2 className="text-3xl font-bold text-white mb-12">Examples of My Work</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="group bg-slate-800/40 p-8 rounded-3xl border border-white/5 hover:border-purple-500/50 transition-all">
            <div className="bg-slate-900/50 h-48 rounded-xl mb-6 flex items-center justify-center text-6xl">🏨</div>
            <h3 className="text-2xl font-bold text-white mb-2">Hotel Booking System</h3>
            <p className="text-teal-400 text-sm font-semibold mb-3">Solved: Manual entry & double bookings</p>
            <p className="text-gray-400 text-sm">A seamless interface for room availability and management.</p>
          </div>
          <div className="group bg-slate-800/40 p-8 rounded-3xl border border-white/5 hover:border-teal-500/50 transition-all">
            <div className="bg-slate-900/50 h-48 rounded-xl mb-6 flex items-center justify-center text-6xl">🧘‍♂️</div>
            <h3 className="text-2xl font-bold text-white mb-2">Spiritual Yoga Classes</h3>
            <p className="text-teal-400 text-sm font-semibold mb-3">Solved: Low walk-in leads</p>
            <p className="text-gray-400 text-sm">Created an attractive webpage featuring a '3 Days Demo Free' system to capture daily leads.</p>
          </div>
        </div>
      </section>

      {/* TEAM CONTACT SECTION (Fixed Links) */}
      <section id="contact" className="relative px-6 lg:px-24 pb-24 z-10">
        <div className="bg-gradient-to-br from-purple-900/60 to-slate-900/80 backdrop-blur-lg p-10 rounded-[2.5rem] border border-purple-500/30 text-center relative overflow-hidden shadow-2xl">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-12">Let's Discuss Your Project</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
            ...
            <div className="bg-slate-900/60 p-8 rounded-3xl border border-teal-500/30 flex flex-col h-full relative overflow-hidden">
              ...
              <p className="text-teal-400 text-sm mb-6 font-semibold uppercase tracking-wider">Lead Developer</p>
              
              {/* Visible Contact Details */}
              <div className="mb-8">
                <p className="text-gray-400 text-[10px] uppercase tracking-widest mb-1">Direct Line</p>
                <p className="text-2xl font-black text-white tracking-wide">+91 89625 23092</p>
                <p className="text-sm text-gray-400 mt-1 font-medium">prinshkushwah07@gmail.com</p>
              </div>

              <div className="mt-auto flex flex-col gap-3">
                <a href="https://wa.me/918962523092?text=Hi%20Prinsh,%20I%20need%20a%20website" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold py-3.5 rounded-xl hover:bg-[#1fae54] transition-all">
                  💬 Message on WhatsApp
                </a>
                <div className="flex gap-2 text-xs">
                  <a href="tel:+918962523092" className="flex-1 text-center bg-slate-800 hover:bg-slate-700 border border-white/5 transition py-3 rounded-lg">📞 Call Now</a>
                  <a href="mailto:prinshkushwah07@gmail.com" className="flex-1 text-center bg-slate-800 hover:bg-slate-700 border border-white/5 transition py-3 rounded-lg">✉️ Send Email</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/60 p-8 rounded-3xl border border-purple-500/30 flex flex-col h-full relative overflow-hidden">
              ...
              <div className="mb-8">
                <p className="text-gray-400 text-[10px] uppercase tracking-widest mb-1">Direct Line</p>
                <p className="text-2xl font-black text-white tracking-wide">+91 96855 35001</p>
                <p className="text-sm text-gray-400 mt-1 font-medium">prinshkushwah07@gmail.com</p>
              </div>

              <div className="mt-auto flex flex-col gap-3">
                <a href="https://wa.me/919685535001?text=Hi%20Priya,%20I%20have%20a%20project%20inquiry" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold py-3.5 rounded-xl hover:bg-[#1fae54] transition-all">
                  💬 Message on WhatsApp
                </a>
                <div className="flex gap-2 text-xs">
                  <a href="tel:+919685535001" className="flex-1 text-center bg-slate-800 hover:bg-slate-700 border border-white/5 transition py-3 rounded-lg">📞 Call Now</a>
                  <a href="mailto:prinshkushwah07@gmail.com" className="flex-1 text-center bg-slate-800 hover:bg-slate-700 border border-white/5 transition py-3 rounded-lg">✉️ Send Email</a>
                </div>
              </div>
            </div>
