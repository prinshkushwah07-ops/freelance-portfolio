    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-cyan-500 selection:text-white relative overflow-hidden">
      ...
      <main className="relative flex flex-col items-center justify-center text-center px-6 pt-20 pb-32">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed font-light">
          Hi, I'm Prinsh. A React & Tailwind expert building lightning-fast,
          high-converting websites. Ready to turn your vision into a stunning
          reality.
        </p>
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 w-full sm:w-auto">
          <a
            href="#projects"
            className="bg-white text-slate-900 px-8 py-4 rounded-full text-lg font-bold hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.3)] transition-all duration-300 w-full sm:w-auto text-center"
          >
            Explore My Work
          </a>
      ...
      <section id="projects" className="relative px-6 lg:px-24 pb-24 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Project 1: The Royal Hotel (MATCHED DESIGN) */}
          <div className="group bg-slate-800/40 backdrop-blur-sm p-8 rounded-3xl border border-white/5 hover:border-cyan-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_-15px_rgba(6,182,212,0.4)] cursor-pointer">
            <div className="bg-slate-900/50 h-40 rounded-xl mb-6 flex items-center justify-center border border-white/5 overflow-hidden">
              <span className="text-5xl group-hover:scale-110 transition-transform duration-500 drop-shadow-2xl">
                👑
              </span>
            </div>
            ...
            <p className="text-cyan-400 text-xs font-semibold tracking-wide mb-3 uppercase">
              Solved: Role-based dashboards & premium UI
            </p>

            <p className="text-gray-400 text-sm mb-5 leading-relaxed">
              A dual-interface React application featuring a luxury dark-mode
              landing page and clean, modern portals for both guests and admin
              staff.
            </p>
          ...
          <div className="group bg-slate-800/40 backdrop-blur-sm p-8 rounded-3xl border border-white/5 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_-15px_rgba(59,130,246,0.4)]">
            ...
            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
              A high-conversion landing page for a local yoga studio featuring a
              "3 Days Demo Free" registration system.
            </p>
          ...
          <div
            id="contact"
            className="bg-gradient-to-br from-slate-800/80 to-slate-900 p-8 rounded-3xl border border-white/10 relative overflow-hidden flex flex-col justify-center"
          >
            ...
            <p className="text-gray-400 text-sm mb-8 z-10">
              I'm currently available for freelance frontend projects.
            </p>
            <div className="space-y-4 z-10 text-sm">
